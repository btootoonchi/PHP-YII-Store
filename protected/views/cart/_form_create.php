...
<div class="wide form span-24">
	<form name="frm_create" method="post" 
		action="<?php echo $_SERVER['PHP_SELF'];?>">
		<input type="hidden" name="Cart(CartId)" 
			value="<?php echo $_SESSION['cartid']?>" />
		<input type="hidden" name="Cart(DateCrested)" 
			value="<?php echo $date; ?>" />
		...
		<table width="100%">
			...
			<tr>
				...
				<td><input name="Cart(Count)" id="Cart_Count" type="text" value="<?php echo $count;?>" /></td>
				<td><?php echo $price;?></td>
			</tr>
			<tr>
				<td><input type="submit" name="yto" value="Add this to my cart"/></td>
			</tr>
		</table>
	</form>
</div>	
